              ...
              <table className="table table-dark table-striped table-hover">
                <thead>
                  <tr>
                    ...
                    <th className='col-4 align-middle text-center'>Marca</th>
                ...
                <tbody>
                  {data.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className='col-5 align-middle'>{item.modelo}</td>
                      <td className='col-4 align-middle'>{item.marca}</td>
