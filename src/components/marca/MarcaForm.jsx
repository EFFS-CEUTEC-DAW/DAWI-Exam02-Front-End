...
export const MarcaForm = () => {
  ...
  const urlBase = 'http://localhost:4000/api/marca';
  const { id } = useParams();
      ...
      <div className='container-fluid'>
        <div className='d-flex justify-content-center align-items-center' style={{height: `100vh`}}>
          <form onSubmit={handlerSubmit}>
            <fieldset>
              <legend> {(id != 0 ? "Modificar" : "Registrar") } Marca </legend>
              ...
              <div className="form-floating mb-3">
                <input type="text" className="form-control bg-primary text-white" id="descripcion" name = "descripcion" placeholder="Nombre Marca" value={dataForm.descripcion} onChange={handlerChange}/>
              ...
              <Link to='/marca' className="m-1 btn btn-danger" title='Regresar al Grid'> Regresar</Link>
            </fieldset>
          </form>
        </div>
      </div>
