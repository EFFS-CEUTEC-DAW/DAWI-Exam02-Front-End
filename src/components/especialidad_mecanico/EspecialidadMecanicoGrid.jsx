...
export const EspecialidadMecanicoGrid = () => {
  ...
  function handlerLoadForm(id) {
    const url = `/especialidad_mecanico_form/${id}`;
    navigate(url);
  }
              ...
              <table className="table table-dark table-striped table-hover">
                <thead>
                  <tr>
                    ...
                    <th className='col-9 align-middle text-center'>Descripción</th>
                ...
                <tbody>
                  {data.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className='col-9 align-middle'>{item.descripcion}</td>
